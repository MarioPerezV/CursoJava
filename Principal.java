...
public class Principal extends JFrame implements ActionListener{
    ...
    private JMenuItem miCalculo,miRojo,miNegro,miVerde,miMorado,miElCreador,miSalir,miNuevo;
...
/*
        ...
        estatus.setBounds(220, 213, 220, 25);
        estatus.setBackground(new java.awt.Color(224, 224, 224));
        estatus.setFont(new java.awt.Font("Andale Mono", 1, 14));
        estatus.setForeground(new java.awt.Color(255, 0, 0));
        add(estatus);
        estatus.addItem("");
        estatus.addItem("Activo");
        estatus.addItem("Inactivo");
*/
